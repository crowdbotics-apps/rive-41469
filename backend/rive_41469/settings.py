"""
Django settings for rive_41469 project.
...
WSGI_APPLICATION = 'rive_41469.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rive_41469 API",
    "DESCRIPTION": "API documentation for rive_41469 App",
    "VERSION": "v1",
}
